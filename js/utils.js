...
var Cityresource = {'none':0, 'small':10000, 'middle':100000, 'big':1000000};

var Peoplealive = {'no':0, 'yes':1};
var Peopleid = {'none':-1};
var Peopleresource = {'none':0, 'dying':200, 'starve':300, 'standard':450, 'enough':800, 'max':1000};
var Peoplecollect = {'none':0, 'max':10};
var Peoplerecycle = {'none':0, 'max':10};
var Peopleconsume = {'none':0, 'max':10};
...
function getFamilyName() {
	...
	'熊', '纪', '舒', '屈', '项', '祝', '董', '梁', 
	'欧阳', '上官', '诸葛', '司马', '至侯', '端木', '司徒', '淳于', '澹台', '轩城', '申屠', '令孤', 
	);
...
function getGivenName() {
	...
	return middleNames[indexMiddle]+lastNames[indexLast];
}
